...
export const Cookies = () => {
  return (
    <div className="flex justify-center items-center flex-col gap-5 md:flex-nowrap sm:h-screen sm:overflow-hidden  p-5  ">
   


        <img src="/retroshop.svg" alt="" className="h-[100px] p-4" />
        <div className="">
            <h2> responsabilidad y compromiso
Política de cookies</h2>
            ...
            <p>Las cookies son pequeños archivos de texto que se instalan en el navegador del ordenador del USUARIO para registrar su actividad enviando una identificación anónima que se almacena en el mismo, con la finalidad de que la navegación sea más sencilla, permitiendo por ejemplo, el acceso a los USUARIOS que se hayan registrado previamente, el acceso a las áreas, servicios o promociones reservados exclusivamente a ellos sin tener que registrarse en cada visita. Se pueden utilizar también para medir la audiencia, parámetros del tráfico y navegación, tiempo de sesión, y/o controlar el progreso y número de entradas. Las cookies se asocian únicamente a un usuario anónimo y su ordenador o dispositivo y no proporcionan referencias que permitan conocer sus datos personales.</p>
